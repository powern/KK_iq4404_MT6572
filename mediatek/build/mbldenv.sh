...
PATH=/opt/jdk1.6.0_26/bin:$PWD/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.6/bin:$PWD/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin:$PWD/prebuilts/misc/linux-x86/make:$PATH
export PATH
