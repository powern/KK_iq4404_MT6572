...
static void OV5645MIPI_set_AWB_mode_UNLOCK(void)
{
...
void OV5645MIPIInitialSetting(void)
{
	...
	OV5645MIPI_write_cmos_sensor(0x3035, 0x41);//	; PLL
	...
	OV5645MIPI_write_cmos_sensor(0x3815, 0x31);//	; Y INC
		OV5645MIPI_write_cmos_sensor(0x3820, 0xf9);//edit by xuke 0603 (0x3820, 0x47);//	; flip off, V bin on
		OV5645MIPI_write_cmos_sensor(0x3821, 0x06);//edit by xuke 0603 (0x3821, 0x07);//	; mirror on, H bin on
	...
	OV5645MIPI_write_cmos_sensor(0x4004, 0x04);//	; BLC line number
	...
	OV5645MIPI_write_cmos_sensor(0x501d, 0x40);//
	...
	OV5645MIPI_write_cmos_sensor(0x5186, 0x18);//
	OV5645MIPI_write_cmos_sensor(0x5187, 0x24);//
	OV5645MIPI_write_cmos_sensor(0x5188, 0x25);//
	OV5645MIPI_write_cmos_sensor(0x5189, 0x81);//
	OV5645MIPI_write_cmos_sensor(0x518a, 0x6b);//
	OV5645MIPI_write_cmos_sensor(0x518b, 0xce);//
	OV5645MIPI_write_cmos_sensor(0x518c, 0x99);//
	OV5645MIPI_write_cmos_sensor(0x518d, 0x39);//
	OV5645MIPI_write_cmos_sensor(0x518e, 0x32);//
	OV5645MIPI_write_cmos_sensor(0x518f, 0x62);//
	OV5645MIPI_write_cmos_sensor(0x5190, 0x57);//
	OV5645MIPI_write_cmos_sensor(0x5191, 0xf5);//
	OV5645MIPI_write_cmos_sensor(0x5192, 0xa);//
	...
	OV5645MIPI_write_cmos_sensor(0x5198, 0x4 );//
	OV5645MIPI_write_cmos_sensor(0x5199, 0x96);//
	OV5645MIPI_write_cmos_sensor(0x519a, 0x4 );//
	OV5645MIPI_write_cmos_sensor(0x519b, 0x0 );//
	OV5645MIPI_write_cmos_sensor(0x519c, 0x8 );//
	OV5645MIPI_write_cmos_sensor(0x519d, 0x25);//
	OV5645MIPI_write_cmos_sensor(0x519e, 0x38);//
	OV5645MIPI_write_cmos_sensor(0x5381, 0x26);//CCM
	OV5645MIPI_write_cmos_sensor(0x5382, 0x4e);
	OV5645MIPI_write_cmos_sensor(0x5383, 0x0c);
	OV5645MIPI_write_cmos_sensor(0x5384, 0x12);
	OV5645MIPI_write_cmos_sensor(0x5385, 0x70);
	OV5645MIPI_write_cmos_sensor(0x5386, 0x82);
	OV5645MIPI_write_cmos_sensor(0x5387, 0x6e);
	OV5645MIPI_write_cmos_sensor(0x5388, 0x58);
	OV5645MIPI_write_cmos_sensor(0x5389, 0x14);
	...
	OV5645MIPI_write_cmos_sensor(0x5302, 0x28);//	; sharpen MT off1
	OV5645MIPI_write_cmos_sensor(0x5303, 0x20);//	; sharpen MT off2
	OV5645MIPI_write_cmos_sensor(0x5304, 0x08);//	; DNS th1
	OV5645MIPI_write_cmos_sensor(0x5305, 0x30);//	; DNS th2 0x30
	OV5645MIPI_write_cmos_sensor(0x5306, 0x08);//	; DNS off1 0x08
	...
	OV5645MIPI_write_cmos_sensor(0x5580, 0x02);//
	OV5645MIPI_write_cmos_sensor(0x5583, 0x48);//
	OV5645MIPI_write_cmos_sensor(0x5584, 0x48);//
	OV5645MIPI_write_cmos_sensor(0x5589, 0x10);//
	OV5645MIPI_write_cmos_sensor(0x558a, 0x00);//
	OV5645MIPI_write_cmos_sensor(0x558b, 0xf8);//
	OV5645MIPI_write_cmos_sensor(0x5800, 0x37);// 32 lsc
	OV5645MIPI_write_cmos_sensor(0x5801, 0x22);// 1d
	OV5645MIPI_write_cmos_sensor(0x5802, 0x16);// 19
	OV5645MIPI_write_cmos_sensor(0x5803, 0x16);// 18
	OV5645MIPI_write_cmos_sensor(0x5804, 0x21);// 1d
	OV5645MIPI_write_cmos_sensor(0x5805, 0x3b);// 38
	OV5645MIPI_write_cmos_sensor(0x5806, 0x15);// 12
	OV5645MIPI_write_cmos_sensor(0x5807, 0x0b);//0a
	OV5645MIPI_write_cmos_sensor(0x5808, 0x08);//07
	OV5645MIPI_write_cmos_sensor(0x5809, 0x08);// 07
	OV5645MIPI_write_cmos_sensor(0x580a, 0x0b);// 0b
	OV5645MIPI_write_cmos_sensor(0x580b, 0x15);// 0f
	OV5645MIPI_write_cmos_sensor(0x580c, 0x0b);// 0e
	OV5645MIPI_write_cmos_sensor(0x580d, 0x05);//
	OV5645MIPI_write_cmos_sensor(0x580e, 0x01);// 00
	OV5645MIPI_write_cmos_sensor(0x580f, 0x00);// 00
	OV5645MIPI_write_cmos_sensor(0x5810, 0x04);// 03
	OV5645MIPI_write_cmos_sensor(0x5811, 0x0c);//0a
	OV5645MIPI_write_cmos_sensor(0x5812, 0x0b);//0c
	OV5645MIPI_write_cmos_sensor(0x5813, 0x05);// 04
	OV5645MIPI_write_cmos_sensor(0x5814, 0x00);//
	OV5645MIPI_write_cmos_sensor(0x5815, 0x00);//
	OV5645MIPI_write_cmos_sensor(0x5816, 0x04);//03
	OV5645MIPI_write_cmos_sensor(0x5817, 0x0c);//0a
	OV5645MIPI_write_cmos_sensor(0x5818, 0x14);//12
	OV5645MIPI_write_cmos_sensor(0x5819, 0x0b);//09
	OV5645MIPI_write_cmos_sensor(0x581a, 0x08);// 06
	OV5645MIPI_write_cmos_sensor(0x581b, 0x08);//05
	OV5645MIPI_write_cmos_sensor(0x581c, 0x1c);//09
	OV5645MIPI_write_cmos_sensor(0x581d, 0x14);// 12
	OV5645MIPI_write_cmos_sensor(0x581e, 0x34);// 32
	OV5645MIPI_write_cmos_sensor(0x581f, 0x1f);//18
	OV5645MIPI_write_cmos_sensor(0x5820, 0x15);// 14
	OV5645MIPI_write_cmos_sensor(0x5821, 0x15);// 13
	OV5645MIPI_write_cmos_sensor(0x5822, 0x1f);// 17
	OV5645MIPI_write_cmos_sensor(0x5823, 0x37);//2d
	OV5645MIPI_write_cmos_sensor(0x5824, 0x24);// 28
	OV5645MIPI_write_cmos_sensor(0x5825, 0x26);//2a
	OV5645MIPI_write_cmos_sensor(0x5826, 0x08);// 28
	OV5645MIPI_write_cmos_sensor(0x5827, 0x26);// 28
	OV5645MIPI_write_cmos_sensor(0x5828, 0x40);//2a 
	OV5645MIPI_write_cmos_sensor(0x5829, 0x08);//28
	OV5645MIPI_write_cmos_sensor(0x582a, 0x24);//25
	OV5645MIPI_write_cmos_sensor(0x582b, 0x22);// 24
	OV5645MIPI_write_cmos_sensor(0x582c, 0x24);//24
	OV5645MIPI_write_cmos_sensor(0x582d, 0x26);// 08
	OV5645MIPI_write_cmos_sensor(0x582e, 0x26);//26
	OV5645MIPI_write_cmos_sensor(0x582f, 0x42);//
	OV5645MIPI_write_cmos_sensor(0x5830, 0x40);//
	OV5645MIPI_write_cmos_sensor(0x5831, 0x42);//
	OV5645MIPI_write_cmos_sensor(0x5832, 0x04);//06
	OV5645MIPI_write_cmos_sensor(0x5833, 0x28);//26
	OV5645MIPI_write_cmos_sensor(0x5834, 0x26);//24
	OV5645MIPI_write_cmos_sensor(0x5835, 0x24);//44
	OV5645MIPI_write_cmos_sensor(0x5836, 0x24);//
	OV5645MIPI_write_cmos_sensor(0x5837, 0x26);//2a
	OV5645MIPI_write_cmos_sensor(0x5838, 0x24);//4a
	OV5645MIPI_write_cmos_sensor(0x5839, 0x26);//2a
	OV5645MIPI_write_cmos_sensor(0x583a, 0x08);//06
	OV5645MIPI_write_cmos_sensor(0x583b, 0x28);//2c
	OV5645MIPI_write_cmos_sensor(0x583c, 0x62);//28
	...
	OV5645MIPI_write_cmos_sensor(0x5001, 0xff);//
	OV5645MIPI_write_cmos_sensor(0x5589, 0x30);//
	OV5645MIPI_write_cmos_sensor(0x5580, 0x04);//
	OV5645MIPI_write_cmos_sensor(0x5580, 0x41);//
	OV5645MIPI_write_cmos_sensor(0x5580, 0x04);//
	OV5645MIPI_write_cmos_sensor(0x5586, 0x28);//
...
UINT32 OV5645MIPIOpen(void)
{
	...
	hwPowerOn(CAMERA_POWER_VCAM_A2, VOL_2800,"CAM");
...
void OV5645MIPI_scene_mode_PORTRAIT()
{
	...
	OV5645MIPI_write_cmos_sensor(0x3212,0x03);
		/*FRAME rate*/
	OV5645MIPI_write_cmos_sensor(0x3A00,0x3c); //fix30
	...
	OV5645MIPI_write_cmos_sensor(0x350b,0x00); 
	OV5645MIPI_write_cmos_sensor(0x350c,0x00); 
	OV5645MIPI_write_cmos_sensor(0x350d,0x00);
	/*CMX*/ 
...
void OV5645MIPI_scene_mode_SUNSET()
{
	...
	OV5645MIPI_write_cmos_sensor(0x3a11,0x50);
