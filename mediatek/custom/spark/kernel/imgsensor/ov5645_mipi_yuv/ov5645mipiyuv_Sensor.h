...
/* sensor size */
#define OV5645MIPI_IMAGE_SENSOR_SVGA_WIDTH          (1280)//(1280)//1280-12
#define OV5645MIPI_IMAGE_SENSOR_SVGA_HEIGHT         (960)//(960) //960-9
#define OV5645MIPI_IMAGE_SENSOR_QSXGA_WITDH         (2560)//(2592) 
#define OV5645MIPI_IMAGE_SENSOR_QSXGA_HEIGHT        (1922)//(1944)
