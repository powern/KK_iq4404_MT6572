...
*/
		   ...
		   if (GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST]) 
		   {
			...
			||(currSensorName && (0 == strcmp(SENSOR_DRVNAME_SP0A28_MIPI_YUV,currSensorName))))
       {  
          PK_DBG("[CAMERA SENSOR] kdCISModulePowerOn get in---SP0A28_MIPI_YUV sensorIdx:%d; pinSetIdx=%d\n",SensorIdx, pinSetIdx);
