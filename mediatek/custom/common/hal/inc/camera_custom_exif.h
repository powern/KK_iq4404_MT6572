...
* Custom EXIF
******************************************************************************/
//<2014/04/09-kylechang. Add LG EXIF Information
#define EN_CUSTOM_EXIF_INFO
//<2014/04/09-kylechang. 
...
#define CUSTOM_EXIF_STRING_MAKE  "LG Electronics"
#if  defined( ARIMA_LO2_HW )
#define CUSTOM_EXIF_STRING_MODEL "LG-X130G"
#else //ARIMA_LO1_HW
#define CUSTOM_EXIF_STRING_MODEL "LG-X147"
#endif
//<2014/04/09-kylechang. 
