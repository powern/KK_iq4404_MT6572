...
//<2014/02/19-Yuting Shih. Add LCM panel OTM8018B(WVGA) and HX8357C(HVGA)
#if defined( ILI9488C_HVGA_DSI_VDO )
extern LCM_DRIVER ili9488c_hvga_dsi_vdo_drv;
#endif
#if defined( HX8379A_WVGA_DSI_VDO )
extern LCM_DRIVER hx8379a_wvga_dsi_vdo_lcm_drv;
#endif
...
#endif
#if defined( HX8357C_HVGA_DSI_VDO )
extern LCM_DRIVER hx8357c_hvga_dsi_vdo_lcm_drv;
#endif
#if defined( HX8389B_WVGA_DSI_VDO )
extern LCM_DRIVER hx8389b_wvga_dsi_vdo_drv;
#endif
//>2014/02/19-Yuting Shih.
...
//<2014/02/21-Yuting Shih. Modified the defined name to match panel.
#if defined(HX8389B_QHD_DSI_VDO)
	&hx8389b_qhd_dsi_vdo_drv,
#endif
//>2014/02/21-Yuting Shih.
...
//<2014/02/19-Yuting Shih. Add LCM panel OTM8018B(WVGA) and HX8357C(HVGA)
#if defined(ILI9488C_HVGA_DSI_VDO)
	&ili9488c_hvga_dsi_vdo_drv,
#endif

#if defined( HX8379A_WVGA_DSI_VDO )
	&hx8379a_wvga_dsi_vdo_lcm_drv,
#endif
...
#if defined( HX8357C_HVGA_DSI_VDO )
	&hx8357c_hvga_dsi_vdo_lcm_drv,
#endif

#if defined( HX8389B_WVGA_DSI_VDO )
	&hx8389b_wvga_dsi_vdo_drv,
#endif
//>2014/02/19-Yuting Shih.
};
